...
<head>
    ...
    <!-- <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('invoice/img/favicons/apple-icon-57x57.png') }}">
    <link rel=" apple-touch-icon" sizes="60x60" href="{{ asset('invoice/img/favicons/apple-icon-60x60.png') }}">
    <link rel=" apple-touch-icon" sizes="72x72" href="{{ asset('invoice/img/favicons/apple-icon-72x72.png') }}">
    <link rel=" apple-touch-icon" sizes="76x76" href="{{ asset('invoice/img/favicons/apple-icon-76x76.png') }}">
    <link rel=" apple-touch-icon" sizes="114x114" href="{{ asset('invoice/img/favicons/apple-icon-114x114.png') }}">
    <link rel=" apple-touch-icon" sizes="120x120" href="{{ asset('invoice/img/favicons/apple-icon-120x120.png') }}">
    <link rel=" apple-touch-icon" sizes="144x144" href="{{ asset('invoice/img/favicons/apple-icon-144x144.png') }}">
    <link rel=" apple-touch-icon" sizes="152x152" href="{{ asset('invoice/img/favicons/apple-icon-152x152.png') }}">
    <link rel=" apple-touch-icon" sizes="180x180" href="{{ asset('invoice/img/favicons/apple-icon-180x180.png') }}">
    <link rel=" icon" type="image/png" sizes="192x192" href="{{ asset('invoice/img/favicons/android-icon-192x192.png') }}">
    <link rel=" icon" type="image/png" sizes="32x32" href="{{ asset('invoice/img/favicons/favicon-32x32.png') }}">
    <link rel=" icon" type="image/png" sizes="96x96" href="{{ asset('invoice/img/favicons/favicon-96x96.png') }}">
    <link rel=" icon" type="image/png" sizes="16x16" href="{{ asset('invoice/img/favicons/favicon-16x16.png') }}">
...
==============================-->
                        <header class="themeholy-header header-layout8">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto">
                                    <div class="header-logo">
                                        <a href="#"><img src="{{ asset('icons/healthy-food.png') }}" alt=" Invar" style="height: 50px; width: 50px;"></a>
                                        <p style="font-weight: bold; font-size: 18px;"> Restaurant AZEK</p>
                                    </div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="header-bottom">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto">
                                        <p class="invoice-number me-4"><b>Invoice No: </b>#{{ $order->id }}</p>
                                        <div class="shape-left"></div>
                                    </div>
                                    <div class="col-auto">
                                        <p class="invoice-date"><b>Date: </b>{{ ($order->updated_at)->toDateString() }}</p>
                                    </div>
                                </div>
                            </div>
                        </header>
                            ...
                            <div class="col-auto">
                                <div class="invoice-right">
                                    ...
                                    <address>
                                        ...
                                        IN 46240, Inoba, Austona <br>
                                        info@Invarhospital.com <br>
                                        +153 6547 3698
                                    </address>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                <b>Payment Info:</b>
                                <p class="mb-0">{{$order->payment_method=="qris"? Str::upper($order->payment_method):ucfirst($order->payment_method) }} <br>
                                </p>
                            </div>
                            <div class="col-auto">
                                <table class="total-table2">
                                    ...
                                    <tr>
                                        <th>Balance Due:</th>
                                        <td>${{ $order->total_price - $order->paid }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
